...
| 로그인 | 회원가입 |
|---------|---------|
| ![로그인 화면](readmeIMG/로그인 화면.JPG) | ![회원가입 화면](readmeIMG/회원가입 화면.JPG) |
...
| 홈 피드 | 게시물 상세보기 |
|---------|---------|
| ![홈 피드 화면](readmeIMG/홈 피드 화면.JPG) | ![게시물 상세보기 화면](readmeIMG/게시물 상세보기 화면.JPG) |
...
![탐색 페이지 화면](readmeIMG/탐색 페이지 화면.JPG)
...
![검색 페이지 화면](readmeIMG/검색 페이지 화면.JPG)
...
| 내 프로필 | 다른 유저 프로필 |
|---------|---------|
| ![내 프로필 화면](readmeIMG/내 프로필 화면.JPG) | ![다른 유저 프로필 화면](readmeIMG/다른유저프로필.JPG) |
...
**P.S**: 이 프로젝트는 Instagram의 디자인을 참고하여 개발되었으며, 학습 및 포트폴리오 목적으로 제작되었습니다.
